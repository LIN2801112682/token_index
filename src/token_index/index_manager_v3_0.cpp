...
namespace ti
{
    ...
    void
    index_manager_v3_0::print_inverted_index() const
    {
        std::cout << _inverted_index;
    }

    frequency_t
    index_manager_v3_0::calc_frequency(const str_t &token) const
    {
    ...
    result_union_set_t
    index_manager_v3_0::retrieve_union(const query_t &query) const
    {
    ...
    index_manager_v3_0::retrieve_intersection(const query_t &query, const str_t &_) const
    {
