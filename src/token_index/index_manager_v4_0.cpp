...
namespace ti
{
    ...
    void
    index_manager_v4_0::push_doc_line_by_id(const doc_id_t &doc_id, const str_t &new_line)
    {
        str_t token;
    ...
    bool
    index_manager_v4_0::del_doc_by_id(const doc_id_t &doc_id)
    {
    ...
    void
    index_manager_v4_0::print_inverted_index() const noexcept
    {
        std::cout << _inverted_index << std::endl;
    }

    frequency_t
    index_manager_v4_0::calc_frequency(const str_t &token) const noexcept
    {
    ...
    result_union_set_t
    index_manager_v4_0::retrieve_union(const query_t &query) const noexcept
    {
    ...
    index_manager_v4_0::retrieve_intersection(const query_t &query, const str_t &) const noexcept
    {
    ...
    result_regex_t
    index_manager_v4_0::retrieve_regex(const std::regex &pattern) const noexcept
    {
