...
void test_out_result(const token_index::index_manager &manager, const token_index::query_vec_t &query_vec,
                     const bool &is_union, const bool &is_save, std::ostream &os)
{
